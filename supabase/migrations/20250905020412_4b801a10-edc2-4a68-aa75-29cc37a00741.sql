-- Update teams table RLS policy to allow authenticated users to create teams
...
-- Allow authenticated users to create new teams (for project creation)
CREATE POLICY "Authenticated users can create teams" ON teams
FOR INSERT WITH CHECK (auth.uid() IS NOT NULL);

-- Allow team owners/members to update their own teams
