-- Add 'unassigned' to the user_role enum
ALTER TYPE user_role ADD VALUE 'unassigned';

-- Update default role for new profiles to be 'unassigned' instead of 'guest'
ALTER TABLE public.profiles ALTER COLUMN role SET DEFAULT 'unassigned'::user_role;

-- Update the handle_new_user function to set unassigned role by default
...
-- Create a new function to use access codes and assign roles
