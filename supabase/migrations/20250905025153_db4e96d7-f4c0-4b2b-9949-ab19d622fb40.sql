...
-- Phase 2: Update user_role enum to remove 'lead'
...
-- Phase 3: Add team_creator_id to teams table
ALTER TABLE public.teams ADD COLUMN team_creator_id UUID REFERENCES auth.users(id);

-- Phase 4: Create join_requests table for community features
...
-- Phase 5: Add project onboarding data to teams
...
-- Phase 6: Update access_codes for creator-based system
